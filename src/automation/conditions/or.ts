...
export type OrConditionOptions = {
    condition: ConditionConfig | ConditionConfig[];
};

export default function createAndCondition(senses: ISenses, options: OrConditionOptions): Condition {
    return async function or(context) {
